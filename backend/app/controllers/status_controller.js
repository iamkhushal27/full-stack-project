...
module.exports = {
  createStatusController: async function (req, res) {
  ...
  getAllStatusController: async function (req, res) {
    const { categoryId } = req.params;
  ...
  getSingleStatusController: async function (req, res) {
  ...
  updateStatusController: async function (req, res) {
    const { categoryId, id } = req.params;
    const data = req.body;
  ...
  deleteStatusController: async function (req, res) {
    const { categoryId, id } = req.params;
