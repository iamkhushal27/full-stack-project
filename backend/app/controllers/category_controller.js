...
module.exports = {
  createCategoryController: async function (req, res) {
  ...
  getAllCategoryController: async function (req, res) {
    const userId = req.user.id;
  ...
  getSingleCategoryController: async function (req, res) {
    const userId = req.user.id;
    const { id } = req.params;
  ...
  updateCategoryController: async function (req, res) {
    const userId = req.user.id;
    const { id } = req.params;
    const data = req.body;
    console.log(id, data);
  ...
  deleteCategoryController: async function (req, res) {
    const userId = req.user.id;
    const { id } = req.params;
