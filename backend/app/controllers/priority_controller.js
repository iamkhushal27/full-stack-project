...
module.exports = {
  createPriorityController: async function (req, res) {
  ...
  getAllPriorityController: async function (req, res) {
    const { categoryId } = req.params;
  ...
  getSinglePriorityController: async function (req, res) {
  ...
  updatePriorityController: async function (req, res) {
    const { categoryId, id } = req.params;
    const data = req.body;
  ...
  deletePriorityController: async function (req, res) {
    const { categoryId, id } = req.params;
