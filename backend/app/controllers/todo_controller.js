...
module.exports = {
  createTodoController: async function (req, res) {
    const user = req.user;
  ...
  getAllTodoController: async function (req, res) {
  ...
  getSingleTodoController: async function (req, res) {
    const userId = req.user.id;
  ...
  updateTodoController: async function (req, res) {
    const userId = req.user.id;
    const id = parsePositiveInt(req.params.id, "todo id");
    const {
      title,
  ...
  deleteTodoController: async function (req, res) {
    const userId = req.user.id;
